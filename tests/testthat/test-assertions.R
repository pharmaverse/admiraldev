...
## Test 59: no error if `arg` is a parameter of a function (deprecation error) ----
test_that("assert_function_param Test 59: no error if `arg` is a parameter of a function (deprecation error)", { # nolint
  hello <- function(name) {
...
## Test 60: error if expected function parameters are missing (deprecation error) ----
test_that("assert_function_param Test 60: error if expected function parameters are missing (deprecation error)", { # nolint
  hello <- function(name) {
    print(sprintf("Hello %s", name))
  }
