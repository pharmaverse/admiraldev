...
- The `patch` branch is reserved for special hot fixes to address bugs
  ...
  Release](https:/pharmaverse.github.io/admiraldev/539_dark_mode_and_navbar_menu_height/dev/articles/release_strategy.html#hot-fix-release)
...
- **Feature** branches are where actual development related to a
  ...
  Guidance](https:/pharmaverse.github.io/admiraldev/539_dark_mode_and_navbar_menu_height/dev/articles/pr_review_guidance.md)
