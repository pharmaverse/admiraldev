...
| `set_values_to`    | List of variable name-value pairs. Use [`process_set_values_to()`](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/reference/process_set_values_to.md) for processing the value and providing user friendly error messages.                                                                                                                                                                                                                                                 |
...
(see
[assertions](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/reference/index.html#section-assertions)).
...
[`demo_fun()`](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/reference/demo_fun.md),
...
functions](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/articles/programming_strategy.html#categorization-of-functions).
...
- `@examples` or `@caption`, `@info`, `@code`: Fully self-contained
  ...
  Guidance](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/articles/unit_test_guidance.html#set-up-the-test-script).
  ...
  Examples](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/articles/writing_custom_examples.md)
...
{admiral}](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral)
for details.
...
guidance](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral).
...
Issues](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/articles/rcmd_issues.md)
