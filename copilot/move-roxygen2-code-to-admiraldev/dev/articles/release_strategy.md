...
4.  **Make a GitHub “release”:** Once the package is accepted and
    ...
    GitHub](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/articles/release_strategy.html#releasing-to-github)
...
3.  **Branch Naming:** The branch name must be prefixed with the issue
    ...
    conventions](https:/pharmaverse.github.io/admiraldev/copilot/move-roxygen2-code-to-admiraldev/dev/articles/git_usage.html#naming-branches)
    guide for details.
