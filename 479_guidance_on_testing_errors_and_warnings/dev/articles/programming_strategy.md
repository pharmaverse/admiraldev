...
| `set_values_to`    | List of variable name-value pairs. Use [`process_set_values_to()`](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/reference/process_set_values_to.md) for processing the value and providing user friendly error messages.                                                                                                                                                                                                                                              |
...
[`demo_fun()`](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/reference/demo_fun.md),
...
functions](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/articles/programming_strategy.html#categorization-of-functions).
...
- `@examples` or `@caption`, `@info`, `@code`: Fully self-contained
  ...
  Guidance](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/articles/unit_test_guidance.html#set-up-the-test-script).
  ...
  Examples](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/articles/writing_custom_examples.md)
...
{admiral}](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral)
for details.
...
guidance](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral).
...
Issues](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/articles/rcmd_issues.md)
