...
4.  **Make a GitHub “release”:** Once the package is accepted and
    ...
    GitHub](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/articles/release_strategy.html#releasing-to-github)
...
3.  **Branch Naming:** The branch name must be prefixed with the issue
    ...
    conventions](https:/pharmaverse.github.io/admiraldev/479_guidance_on_testing_errors_and_warnings/dev/articles/git_usage.html#naming-branches)
    guide for details.
