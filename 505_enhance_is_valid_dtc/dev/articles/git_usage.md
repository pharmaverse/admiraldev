...
- The `patch` branch is reserved for special hot fixes to address bugs
  ...
  Release](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/articles/release_strategy.html#hot-fix-release)
...
- **Feature** branches are where actual development related to a
  ...
  Guidance](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/articles/pr_review_guidance.md)
