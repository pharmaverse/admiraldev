...
- An exception is made for
  ...
  `get_admiral_option()` and `set_admiral_options()`, where we have
  certain pre-defined defaults with added flexibility to allow for
  user-defined defaults on *commonly used* function arguments
...
| `set_values_to`    | List of variable name-value pairs. Use [`process_set_values_to()`](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/reference/process_set_values_to.md) for processing the value and providing user friendly error messages.                                                                                                                                                                                                                                                                 |
...
[`demo_fun()`](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/reference/demo_fun.md),
...
functions](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/articles/programming_strategy.html#categorization-of-functions).
...
- `@examples` or `@caption`, `@info`, `@code`: Fully self-contained
  ...
  Guidance](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/articles/unit_test_guidance.html#set-up-the-test-script).
  ...
  Examples](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/articles/writing_custom_examples.md)
...
will display all the Date/Time functions available in
[admiral](https://pharmaverse.github.io/admiral/) to the user in the
**See Also** section of `derive_vars_dy()` function documentation.
...
{admiral}](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral)
for details.
...
guidance](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral).
...
Issues](https:/pharmaverse.github.io/admiraldev/505_enhance_is_valid_dtc/dev/articles/rcmd_issues.md)
