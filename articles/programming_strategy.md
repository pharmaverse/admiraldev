...
- If the function needs to create temporary variables in an input
  ...
  [`get_new_tmp_var()`](https://pharmaverse.github.io/admiraldev/reference/get_new_tmp_var.md)
...
| `set_values_to`    | List of variable name-value pairs. Use [`process_set_values_to()`](https://pharmaverse.github.io/admiraldev/reference/process_set_values_to.md) for processing the value and providing user friendly error messages.                                                                                                                                                                                                                                                                                             |
...
- `@examples` or `@caption`, `@info`, `@code`: Fully self-contained
  ...
  Examples](https://pharmaverse.github.io/admiraldev/articles/writing_custom_examples.md)
...
- **Phase 1:** In the release where the identified function or argument
  ...
  [`deprecate_inform()`](https://pharmaverse.github.io/admiraldev/reference/deprecate_inform.md).
...
Issues](https://pharmaverse.github.io/admiraldev/articles/rcmd_issues.md)
