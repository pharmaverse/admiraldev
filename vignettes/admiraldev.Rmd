...
* Vignettes on working on `{admiral}` functions, developing unit testing, releases process, vignette writing and other documentation needs.  These vignettes are intended for use across all admiral packages. Depending what we remove this will need to be properly updated.
...
Do we need to migrate a few assertion functiosn from core to dev then?
