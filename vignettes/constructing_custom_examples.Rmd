...
This vignette serves as a primer to help construct detailed and consistent 
Examples Sections in function documentation using the custom `rdx_roclet()` , which lives in the {admiraldev} package
