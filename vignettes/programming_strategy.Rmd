...
message will include the a recommendation on which function or argument to change 
to in their code.
...
message will appear to the user for _one year_.  The message a recommendation on which 
...
The documentation will be updated at Phase 2:
...
### For Deprecated Functions that Issues a Message (Phase 1)
...
### For Deprecated Functions that Issues an Error (Phase 3)
