...
functions - see `rdx_roclet()` and further down for more details.
...
Guidance](unit_test_guidance.html#set-up-the-test-script).
    ...
    few examples and no explanation.
    
    For more complex functions, the (custom) `@caption`, `@info`, and `@code`
    tags should be used. The `@caption` tag should be used to provide a brief
    ...
    See [`derive_extreme_records.R` in admiral](https://github.com/pharmaverse/admiral/blob/main/R/derive_extreme_records.R) for an example.
