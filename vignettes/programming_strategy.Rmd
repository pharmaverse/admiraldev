...
this. With regards to [lintr](https://github.com/jimhester/lintr), `{admiral}` and all
related packages should maintain consistent linting standards by ensuring that the 
`.lintr` configuration file uses the `admiraldev::admiral_linters()`. These contain
