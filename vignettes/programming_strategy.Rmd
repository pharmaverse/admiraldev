...
In addition to the roxygen2 tags, the `@family` and `@keywords` tags are also used. 

The family/keywords are used to categorize the function. Please see section [Categorization of functions](programming_strategy.html#categorization-of-functions).
