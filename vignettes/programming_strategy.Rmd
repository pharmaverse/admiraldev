...
_one year_. Templates, vignettes and any internal calls should be updated to use the new recommended function.   
...
**Phase 4:**  All mentions of argument are completely removed from admiral.  
