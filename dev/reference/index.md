...
- [`assert_date_var()`](https://pharmaverse.github.io/admiraldev/dev/reference/assert_date_var.md)
...
- [`is_auto()`](https://pharmaverse.github.io/admiraldev/dev/reference/is_auto.md)
...
- [`capture_output()`](https://pharmaverse.github.io/admiraldev/dev/reference/capture_output.md)
  : Capture Output and Messages
- [`parse_code()`](https://pharmaverse.github.io/admiraldev/dev/reference/parse_code.md)
  : Parse Code
...
- [`anti_join()`](https://pharmaverse.github.io/admiraldev/dev/reference/joins.md)
  [`inner_join()`](https://pharmaverse.github.io/admiraldev/dev/reference/joins.md)
  [`left_join()`](https://pharmaverse.github.io/admiraldev/dev/reference/joins.md)
  : Join Functions
