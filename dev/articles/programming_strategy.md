...
- If the function needs to create temporary variables in an input
  ...
  dataset by calling
  [`remove_tmp_vars()`](https://pharmaverse.github.io/admiraldev/dev/reference/remove_tmp_vars.md).
...
| `set_values_to`    | List of variable name-value pairs. Use [`process_set_values_to()`](https://pharmaverse.github.io/admiraldev/dev/reference/process_set_values_to.md) for processing the value and providing user friendly error messages.                                                                                                                                                                                                                                                                                         |
...
functions](https://pharmaverse.github.io/admiraldev/dev/articles/programming_strategy.html#categorization-of-functions).
...
- `@examples` or `@caption`, `@info`, `@code`: Fully self-contained
  ...
  Guidance](https://pharmaverse.github.io/admiraldev/dev/articles/unit_test_guidance.html#set-up-the-test-script).
  ...
  Examples](https://pharmaverse.github.io/admiraldev/dev/articles/writing_custom_examples.md)
...
{admiral}](https://pharmaverse.github.io/admiraldev/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral)
for details.
...
guidance](https://pharmaverse.github.io/admiraldev/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral).
