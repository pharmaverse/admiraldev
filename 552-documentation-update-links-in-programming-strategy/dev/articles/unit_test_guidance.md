...
Strategy](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/articles/programming_strategy.html#function-header-documentation)
...
When a user actions a pull request in {admiral} GitHub repo, the unit
