...
- If the function needs to create temporary variables in an input
  ...
  to avoid that variables of the input dataset are accidentally
  overwritten. The temporary variables must be removed from the output
  dataset by calling
...
| `set_values_to`    | List of variable name-value pairs. Use [`process_set_values_to()`](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/reference/process_set_values_to.md) for processing the value and providing user friendly error messages.                                                                                                                                                                                                                                   |
...
If there is a good case to be made for altering any of the default
configurations, this can be done by passing arguments to
`admiral_linters()`, for instance:
...
function helps with handling arguments in a case-insensitive manner.
...
for more complex functions - see
...
[`demo_fun()`](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/reference/demo_fun.md),
and further down for more details.
...
functions](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/articles/programming_strategy.html#categorization-of-functions).
...
- `@examples` or `@caption`, `@info`, `@code`: Fully self-contained
  ...
  (specify [`library(dplyr)`](https://dplyr.tidyverse.org) before
  calling this function). Make sure to align columns as this ensures
  quick code readability. If other functions are called in the example,
  please specify
  [`library(pkg_name)`](https://rdrr.io/r/base/library.html) then refer
  to the respective function `fun()` as opposed to the preferred
  `pkg_name::fun()` notation as specified in [Unit Test
  Guidance](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/articles/unit_test_guidance.html#set-up-the-test-script).
  ...
  Examples](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/articles/writing_custom_examples.md)
...
from `dplyr` the following line would have to be included in that file:
...
{admiral}](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral)
for details.
...
- **Phase 1:** In the release where the identified function or argument
  ...
  This message will appear to the user for at least *one year*.
...
to issue a message, warning or error using
[`deprecate_inform()`](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/reference/deprecate_inform.md),
...
**Phase 1:** At the start of this phase the call to
[`deprecate_inform()`](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/reference/deprecate_inform.md)
will appear as:
...
guidance](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/articles/unit_test_guidance.html#writing-unit-tests-in-admiral).
...
Issues](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/articles/rcmd_issues.md)
