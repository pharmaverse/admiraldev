...
- The `patch` branch is reserved for special hot fixes to address bugs
  ...
  Release](https:/pharmaverse.github.io/admiraldev/552-documentation-update-links-in-programming-strategy/dev/articles/release_strategy.html#hot-fix-release)
